...
::**********************************************************************
SET $NAME=%~n0
SET $DESCRIPTION=Post processing Geoname database for escaped tags [SQLite]
...
:init
    ...
    TITLE %$NAME%: Post processing data
    :: Note the terminating ".quit": -init ignores .q in the SQL load file
    CALL "%$SQLite.exe%" "%_DataDir%\geonames.sqlite" -init "sql\PostLoadGeoname.SQLite.sql" .quit
    TITLE %$NAME%: Post processing data DONE
::*** End of File *****************************************************